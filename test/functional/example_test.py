...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the AstraTestFramework
    pass

class ExampleTest(AstraTestFramework):
    # Each functional test is a subclass of the AstraTestFramework class.
    ...
    def custom_method(self):
        ...
        AstraTestFramework class so other tests can use it."""
