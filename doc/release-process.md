...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/ASTRA-Project/ASTRA/blob/master/doc/translation_process.md#synchronising-translations).
...
### Build and sign Astracore for Linux, Windows, and OS X:
...
- Detached signatures will then be committed to the [detached-sigs](https://github.com/ASTRA-Project/detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the astracore.io server*.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/ASTRA-Project/ASTRA/releases/new) with a link to the archived release notes.
