 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called ASTRA (http://www.luxcore.io),
...
bool AppInit(int argc, char* argv[])
{
    ...
    if (mapArgs.count("-?") || mapArgs.count("-h") ||  mapArgs.count("-help") || mapArgs.count("-version")) {
        ...
        if (mapArgs.count("-version")) {
            ...
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  luxd [options]                     " + _("Start Astracore Daemon") + "\n";
