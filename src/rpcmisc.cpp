...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"darksend_balance\": xxxxxx, (numeric) the anonymized astra balance of the wallet\n"
...
UniValue getstateinfo(const UniValue& params, bool fHelp)
{
    ...
    AstraDGP astraDGP(globalState.get());

    UniValue obj(UniValue::VOBJ);
    obj.push_back(Pair("maxblocksize", (int)astraDGP.getBlockSize(chainActive.Height())));
    obj.push_back(Pair("blockgaslimit", (int)astraDGP.getMinGasPrice(chainActive.Height())));
    obj.push_back(Pair("mingasprice", (int)astraDGP.getBlockGasLimit(chainActive.Height())));
