...
The Astracore project operates an open contributor model where anyone is
...
The following applies to code changes to the Astracore project, and is not to be
confused with overall ASTRA Network Protocol consensus changes.

Whether a pull request is merged into Astracore rests with the project merge
...
The project leader is the release manager for each Astracore release.
